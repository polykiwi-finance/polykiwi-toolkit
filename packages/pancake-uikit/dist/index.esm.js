...
function getConfig () {
    ...
    var promise = request('https://api.concha.io/api/graphql', query);
...
var query = gql(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  query {\n    Project(where: {id: \"ckrbsgs3b008972he15vja271\"} ) {\n      name\n      images {\n        name\n        image {\n          publicUrl\n        }\n      }\n      themes {\n        type\n        failure\n        primary\n        primaryBright\n        primaryDark\n        secondary\n        success\n        binance\n        overlay\n        background\n        backgroundDisabled\n        backgroundAlt\n        cardBorder\n        contrast\n        dropdown\n        dropdownDeep\n        invertedContrast\n        input\n        inputSecondary\n        tertiary\n        text\n        textDisabled\n        textSubtle\n        disabled\n        gradientBubblegum\n        gradientInverseBubblegum\n        gradientCardHeader\n        gradientBlue\n        gradientViolet\n        gradientVioletAlt\n        gradientGold\n      }\n    }\n  }\n"], ["\n  query {\n    Project(where: {id: \"ckrbsgs3b008972he15vja271\"} ) {\n      name\n      images {\n        name\n        image {\n          publicUrl\n        }\n      }\n      themes {\n        type\n        failure\n        primary\n        primaryBright\n        primaryDark\n        secondary\n        success\n        binance\n        overlay\n        background\n        backgroundDisabled\n        backgroundAlt\n        cardBorder\n        contrast\n        dropdown\n        dropdownDeep\n        invertedContrast\n        input\n        inputSecondary\n        tertiary\n        text\n        textDisabled\n        textSubtle\n        disabled\n        gradientBubblegum\n        gradientInverseBubblegum\n        gradientCardHeader\n        gradientBlue\n        gradientViolet\n        gradientVioletAlt\n        gradientGold\n      }\n    }\n  }\n"
    /*
...
var Logo$2 = function (_a) {
    ...
    //@ts-ignore
    var logo = !isDark ? React.createElement("img", { src: logoLight, alt: "polykiwi logo", style: { height: '26px' } }) : React.createElement("img", { src: logoDark, alt: "polykiwi logo", style: { height: '26px' } });
    return logo;
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null, !isDark ? React.createElement("img", { src: logoLight, alt: "polykiwi logo", style: { height: '26px' } }) : React.createElement("img", { src: logoDark, alt: "polykiwi logo", style: { height: '26px' } })));
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://quickswap.exchange/#/swap?outputCurrency=0xD664b8d8624750a4f945fe9efb1438e9e021cd56", target: "_blank" },
...
var SocialLinks = function () { return (React.createElement(Flex, null, socials.map(function (social, index) {
    ...
    if (social.items) {
        return (
        // @ts-ignore
        React.createElement(Dropdown, { key: social.label, position: "top", target: React.createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "textSubtle" }, item.label)); })));
    }
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React.createElement("div", null));
    if (isExternal) {
