...
function getConfig () {
    ...
    var localConfig = window.localStorage.getItem('projectConfig');
    localConfig = !localConfig ? null : JSON.parse(localConfig);
    var promise = graphqlRequest.request('https://api.concha.io/api/graphql', query);
    promise.then(function (projectConfig) {
        window.localStorage.setItem('projectConfig', JSON.stringify(projectConfig.Project));
        cachedVal = projectConfig.Project;
    });
    if (!localConfig) {
        document.body.style.display = 'none';
        promise.finally(function () { return location.reload(); });
        throw new Error('Config not loaded');
    }
    return localConfig;
}
var query = graphqlRequest.gql(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  query {\n    Project(where: {id: \"ckrbsgs3b008972he15vja271\"} ) {\n      name\n      images {\n        name\n        image {\n          publicUrl\n        }\n      }\n      themes {\n        type\n        failure\n        primary\n        primaryBright\n        primaryDark\n        secondary\n        success\n        binance\n        overlay\n        background\n        backgroundDisabled\n        backgroundAlt\n        cardBorder\n        contrast\n        dropdown\n        dropdownDeep\n        invertedContrast\n        input\n        inputSecondary\n        tertiary\n        text\n        textDisabled\n        textSubtle\n        disabled\n        gradientBubblegum\n        gradientInverseBubblegum\n        gradientCardHeader\n        gradientBlue\n        gradientViolet\n        gradientVioletAlt\n        gradientGold\n      }\n    }\n  }\n"], ["\n  query {\n    Project(where: {id: \"ckrbsgs3b008972he15vja271\"} ) {\n      name\n      images {\n        name\n        image {\n          publicUrl\n        }\n      }\n      themes {\n        type\n        failure\n        primary\n        primaryBright\n        primaryDark\n        secondary\n        success\n        binance\n        overlay\n        background\n        backgroundDisabled\n        backgroundAlt\n        cardBorder\n        contrast\n        dropdown\n        dropdownDeep\n        invertedContrast\n        input\n        inputSecondary\n        tertiary\n        text\n        textDisabled\n        textSubtle\n        disabled\n        gradientBubblegum\n        gradientInverseBubblegum\n        gradientCardHeader\n        gradientBlue\n        gradientViolet\n        gradientVioletAlt\n        gradientGold\n      }\n    }\n  }\n"
    /*
...
var lightTheme$1 = (_a$1 = settings === null || settings === void 0 ? void 0 : settings.themes) === null || _a$1 === void 0 ? void 0 : _a$1.find(function (i) { return i.type === 'light'; });
var darkTheme$1 = (_b = settings === null || settings === void 0 ? void 0 : settings.themes) === null || _b === void 0 ? void 0 : _b.find(function (i) { return i.type === 'dark'; });
function parseTheme(theme) {
    var res = __assign(__assign({}, theme), { gradients: {
...
var Logo$2 = function (_a) {
    ...
    // @ts-ignore
    var logoLight = config.images !== undefined ? (_c = (_b = config.images) === null || _b === void 0 ? void 0 : _b.find(function (image) { return image.name === 'header-logo-light'; }).image) === null || _c === void 0 ? void 0 : _c.publicUrl : '';
    // @ts-ignore
    var logoDark = config.images !== undefined ? (_e = (_d = config.images) === null || _d === void 0 ? void 0 : _d.find(function (image) { return image.name === 'header-logo-dark'; }).image) === null || _e === void 0 ? void 0 : _e.publicUrl : '';
    //@ts-ignore
    var logo = !isDark ? React__default['default'].createElement("img", { src: logoLight, alt: "polykiwi logo", style: { height: '26px' } }) : React__default['default'].createElement("img", { src: logoDark, alt: "polykiwi logo", style: { height: '26px' } });
    return logo;
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null, !isDark ? React__default['default'].createElement("img", { src: logoLight, alt: "polykiwi logo", style: { height: '26px' } }) : React__default['default'].createElement("img", { src: logoDark, alt: "polykiwi logo", style: { height: '26px' } })));
...
var links = [
    ...
    },
    {
        label: "Trade",
        icon: "TradeIcon",
        href: "https://quickswap.exchange/#/swap?outputCurrency=0xD664b8d8624750a4f945fe9efb1438e9e021cd56"
    }
    /*
    items: [
      {
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/PolyKiwi_Finance",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/PolyKiwiFinance",
    },
];
var MENU_HEIGHT = 64;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://quickswap.exchange/#/swap?outputCurrency=0xD664b8d8624750a4f945fe9efb1438e9e021cd56", target: "_blank" },
...
var SocialLinks = function () { return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
    ...
    if (social.items) {
        return (
        // @ts-ignore
        React__default['default'].createElement(Dropdown, { key: social.label, position: "top", target: React__default['default'].createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React__default['default'].createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "textSubtle" }, item.label)); })));
    }
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement("div", null));
    if (isExternal) {
